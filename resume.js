...
const resume = [
    ...
    ['h1', 'ATTENTION!'],
    ['p', "I'm normally a software developer working on my startup. I'm happy to do other jobs (even with much lesser pay) on the side to cover my poor startup lifestyle. I hope the pictures below suggests that I'm fit for the job."],
