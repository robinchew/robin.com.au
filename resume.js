...
const resume = [
    ...
    ['h1', 'ATTENTION!'],
    ['p', "I'm normally a software developer working on my startup. I'm happy to do other jobs (even with much lesser pay) on the side to cover my poor startup lifestyle. I hope the picture of my home office computer setup below suggests that I'm fit for the job."],
    ['img', { src: 'computer-setup-2025.jpg', style: 'width: 100%' }],
    ['p', 'Or else, my apologies, all I got is programming experience below.'],
